...
public class SpendScreen extends JFrame{
		...
		okBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(dateText.getText().equals("")) {
					...
					JOptionPane.showMessageDialog(null, "지출을 입력하세요!");
				}
					...
					try {
					FileWriter fw=new FileWriter("지출 내역.txt",true);    //파일명과 같은 파일명이 존재할시 덧붙여쓸여부판단
		            ...
		            JOptionPane.showMessageDialog(null, "지출이 입력되었습니다.");
						dispose();
