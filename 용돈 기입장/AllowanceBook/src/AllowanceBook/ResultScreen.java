...
public class ResultScreen extends JFrame {
	...
	public ResultScreen() {
		...
		try { 
			...
			BufferedReader income = new BufferedReader(new FileReader("¼öÀÔ ³»¿ª.txt"));
			BufferedReader spend = new BufferedReader(new FileReader("ÁöÃâ ³»¿ª.txt"));
		...
		incomeT = new JButton("¼öÀÔ¾×");
		incomeT.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå ExtraBold", Font.PLAIN, 18));
		incomeT.setFocusable(false);
		incomeT.setContentAreaFilled(false);
		incomeT.setBorderPainted(false);
		incomeT.setBounds(26, 21, 100, 35);
		
		spendT = new JButton("ÁöÃâ¾×");
		spendT.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå ExtraBold", Font.PLAIN, 18));
		spendT.setFocusable(false);
		spendT.setContentAreaFilled(false);
		spendT.setBorderPainted(false);
		spendT.setBounds(26, 78, 100, 35);
		
		total = new JButton("ÃÑ ÇÕ°è");
		total.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå ExtraBold", Font.PLAIN, 18));
		...
		incomeTotal.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå ExtraBold", Font.PLAIN, 18));
		...
		spendTotal.setFont(new Font("³ª´®½ºÄù¾î¶ó¿îµå ExtraBold", Font.PLAIN, 18));
